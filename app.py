...
if not df_log.empty:
    ...
    # 2. PAKKOKORJAUS: Lasketaan 1RM uudelleen, jotta dashboard ei näytä nollia
...
with tab1:
    ...
    if not df_log.empty:
        # NYKYTILANNE: Viimeisin 1RM per käyttäjä
